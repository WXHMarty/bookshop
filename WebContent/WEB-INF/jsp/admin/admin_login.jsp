		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/admin/login" method="post">
					<!-- start of login form -->
					<div id="welcome">
					...
					<div id="user-name">
						...
						<span><input type="text" name="admin.name" class="form-input"></span>
					</div>
					<div id="user-password">
						<span class="item">密&nbsp;&nbsp;&nbsp;码:</span>
						<span class="input"><input type="password" name="admin.password" class="form-input"></span>
					</div>
					<div id="button-group">
