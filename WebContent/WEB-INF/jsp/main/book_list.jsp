...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class='your_position'>
			您现在的位置:&nbsp;
			<a href="${pageContext.request.contextPath}/book/Style_execute">网上书屋</a> &gt;&gt;<span>${cat.cvalue }</span>
							...
							<li>
								<div>
									...
									<div class=second_fenlei3>
										<a>${c.cvalue }&nbsp;(${c.bnumber })</a>
									</div>
									</s:if>
									<s:else>
									<div class=second_fenlei>
										<a href="BookList_execute?c1=${c1 }&c2=${c.cid}">${c.cvalue }&nbsp;(${c.bnumber })</a>
									</div>
									</s:else>
								</div>
							</li>
						...
						<div id="divTopPageNavi" class="list_r_title_text3">
							...
							<div class='list_r_title_text3a'>
								<a name=link_page_next
									href="BookList_execute?c1=${c1 }&c2=${c2}&page=${page-1}">
