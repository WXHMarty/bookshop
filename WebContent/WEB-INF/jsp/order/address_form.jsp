...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>&nbsp; 
		...
		<div class="fill_message">
			...
			<form name="ctl00" method="post" action="Orders_consignee" id="f">
				<s:token></s:token>
				<input type="hidden" name="order.oid" id="addressId" value="-1"/>
				...
				<table class="tab_login">
					...
					<tr>
						...
						<td>
							<input type="text" name="order.address" class="text_input"
								id="fullAddress" />
					...
					<tr>
						...
						<td>
							<input type="text" class="text_input" name="order.zipCode"
								id="postalCode" />
				...
				<div class="login_in">
					...
					<a href="${pageContext.request.contextPath}/item/payment"><input id="btnClientRegister2" class="button_1" name="submit"
