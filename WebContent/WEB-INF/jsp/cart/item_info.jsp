...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<br />
			<div class="login_in">
				<a href="${pageContext.request.contextPath}/item/ItemMove_execute">
					<input id="btnClientRegister" class="button_1" name="submit"
					type="submit" value="取消" /></a>
			
				<a href="${pageContext.request.contextPath}/order/Orders_execute"><input id="btnClientRegister" class="button_1" name="submit"
